...
def recognize_faces(frame, model, classifier, label_encoder):
    """
    ...
    # Decode the label
    label = label_encoder[predictions[0]]
    confidence = max(probabilities[0]) * 100  # Confidence in percentage
...
print("Starting webcam for face recognition. Press 'q' to quit.")
